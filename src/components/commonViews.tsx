...
const styles = StyleSheet.create({
  ...
  commonLineDotted: {
    height: 1, width: '100%', marginTop : 10, borderRadius: 1, borderWidth: 1, borderColor: '#DBDBDB', borderStyle: 'dashed', zIndex: 0,  
  },
  commonLineDottedInner: {
    position: 'absolute', left: 0, bottom: 0, width: '100%', height: 1, backgroundColor: 'white', zIndex: 1
  },
  roundView: {
    borderRadius: 25,
    height: 50,
...
export const CommonLineDottedInner = styled(View)`
  ${commonLineDottedInner};
`;
